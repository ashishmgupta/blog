...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 width=100%>
 ...
 <tr style='height:45.75pt'>
  <td rowspan=7>
  <p class=MyNormalStyle> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. Wireshark Practice</p>
  </td>
  <td>
 ...
 <tr>
  ...
  <td >
  <p class=MyNormalStyle style='margin-bottom:0in;line-height:normal'>Used XXE injection.</p>
  </td>
 </tr>
 <tr>
  <td >
 ...
 <tr>
  ...
  <td >
  <p class=MyNormalStyle style='margin-bottom:0in;line-height:normal'>Install Trufflehog on local machine and
  used on given repo.</p>
  </td>
 </tr>
 <tr>
  <td >
  <p class=MyNormalStyle style='margin-left:.5in;text-indent:-.25in'>16.&nbsp;&nbsp; Exploitation via AWS
  CLI</p>
  </td>
  <td >
  ...
  <td >
  <p class=MyNormalStyle style='margin-bottom:0in;line-height:normal'>Configure the creds found via Trufflehog
  and then use AWS CLI on it to get lambda URLs.</span></p>
  </td>
 </tr>
 <tr>
  <td >
  <p class=MyNormalStyle style='margin-left:.5in;text-indent:-.25in'>17.<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp; </span>Buy A Hat</p>
  </td>
  <td >
  <p class=MyNormalStyle><i>Solved in the game</i></p>
  </td>
  <td>
  <p class=MyNormalStyle style='margin-bottom:0in;line-height:normal'>Followed the instructions.</span></p>
  </td>
 </tr>
 <tr>
  <td>
  <p class=MyNormalStyle style='margin-left:.5in;text-indent:-.25in'>18.<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp; </span>Blockchain
  Divination</p>
  </td>
  <td>
  ...
  <td>
  <p class=MyNormalStyle style='margin-bottom:0in;line-height:normal'>The "To address" in the transaction has
  the answer.</span></p>
  </td>
 </tr>
 <tr>
  <td>
  <p class=MyNormalStyle style='margin-left:.5in;text-indent:-.25in'>19.<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp; </span>Exploit a smart
  contract</p>
  </td>
  <td>
  <p class=MyNormalStyle><i>Solved in the game</i></p>
  ...
  <td>
  <p class=MyNormalStyle style='margin-bottom:0in;line-height:normal'>The client side javascript in the app has the hard coded "root" value.<br> 
