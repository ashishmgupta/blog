...
<p class=MyNormalStyle>This year the challenge is based on "Lord of the Rings" series. You are tasks to to recover 5 golden rings with each ring requiring you to solve a number of challenges.</p>
