...
<p class=MyNormalStyle>This year the challenge is based on "Lord of the Rings" series. <br>You are tasked to recover 5 golden rings with each ring requiring you to solve several challenges. <br> Completing all the challenges also uncovers the whole story.</p>
