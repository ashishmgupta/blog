<img src="images/blog_images/banner.png" alt="drawing" width="100%"/><br>
# Overview
<p class=MyNormalStyle>Hello and welcome to my SANS Holiday Hack Challenge 2022 write-up.<br>
SANS Holiday Hack Challenge is a holiday themed and gamified cybersecurity competition. <br>
The hands-on challenges encompass a number of cyber security areas namely network security, application security, cloud security to name a few.<br>
This year the challenge is based on "Lord of the Rings" series. <br>You are tasked to recover 5 golden rings with each ring requiring you to solve several challenges. <br> Completing all the challenges also uncovers the whole story.
<br>You can read more about the challenge on SANS official website <a href="https://holidayhackchallenge.com/2020/" target=_blank>here.</a>
</p>
...
# Overview
<p class=MyNormalStyle>Hello and welcome to my SANS Holiday Hack Challenge 2022 write-up.</p>
...
<p class=MyNormalStyle>I was able to complete all of challenges and recover all the rings.</p>
